<div>
    <x-mary-button class="btn-primary btn-sm" label="New User" wire:click="$toggle('showModal')"/>

    <x-mary-modal wire:model="showModal" persistent>
        <x-mary-form wire:submit="save">

            <h2 class="text-base dark:text-white font-semibold leading-7 text-gray-900 border-b pb-2">New User</h2>
